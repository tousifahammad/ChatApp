...
//
//        if (ContextCompat.checkSelfPermission(VideoCallActivity.this, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(VideoCallActivity.this, android.Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
...
//        sinchClient.start();
//
//        sinchClient.getCallClient().addCallClientListener(new VideoCallActivity().VideoCallListener ());
//
//
...
//                        call.addCallListener(new VideoCallActivity.SinchCallListener());
...
//    }
//
//    private class VideoCallListener  implements CallListener {
//        @Override
...
//            call = incomingCall;
//            Toast.makeText(VideoCallActivity.this, "incoming call", Toast.LENGTH_SHORT).show();
//            call.answer();
//            call.addCallListener(new VideoCallActivity.SinchCallListener());
//            button.setText("Hang Up");
//        }
