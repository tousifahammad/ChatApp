...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipientProfileImageUrl = getIntent().getStringExtra("recipientImage");

        calling_to = findViewById(R.id.name);
    ...
    private void updateUI() {
        ...
        Picasso.with(CallScreenActivity.this).load(recipientProfileImageUrl).placeholder(R.drawable.default_avatar).into(profile_image);
        Call call = getSinchServiceInterface().getCall(mCallId);
        if (call != null) {
