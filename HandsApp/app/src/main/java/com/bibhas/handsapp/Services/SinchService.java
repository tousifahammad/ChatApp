...
import com.bibhas.handsapp.IncomingCallScreenActivity;
...
//    private static final String APP_KEY = SharedData.APP_KEY;
//    private static final String APP_SECRET = SharedData.APP_SECRET;
//    private static final String ENVIRONMENT = SharedData.ENVIRONMENT;
    ...
    private void createClient(String userName) {
        mSinchClient = Sinch.getSinchClientBuilder().context(getApplicationContext()).userId(userName)
                ...
                .environmentHost(SharedData.ENVIRONMENT).build();
